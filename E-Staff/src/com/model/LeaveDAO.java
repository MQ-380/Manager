...
public class LeaveDAO {
	...
	public Leave findById(java.lang.Integer id) {
		...
		try {
			Leave instance = (Leave) getCurrentSession().get("com.model.Leave",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Leave instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.model.Leave")
	...
	public Leave merge(Leave detachedInstance) {
		...
		try {
			Leave result = (Leave) getCurrentSession().merge(detachedInstance);
	...
	public static LeaveDAO getFromApplicationContext(ApplicationContext ctx) {
		return (LeaveDAO) ctx.getBean("LeaveDAO");
	}
}